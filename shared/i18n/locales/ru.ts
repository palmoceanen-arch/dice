...
export const ru: TranslationKeys = {
  ...
  // Матчмейкинг (Яндекс-лобби)
  multiplayer: {
    title: 'Мультиплеер',
    quickPlay: 'Быстрая игра',
    quickPlayHint: 'Подобрать случайного соперника',
    ...
    modeAny: 'Любой',
    modeAnySub: 'Стол · от 3 до 5 игроков',
    selectGameMode: 'Выберите игру',
    selectMode: 'Выберите формат',
    selectBet: 'Выберите ставку',
    betAmount: 'Ставка',
    noBet: 'Без ставки',
    noBetSub: 'Бесплатная игра · победителю фиксированные очки',
    winnerTakesBank: 'Победитель забирает банк',
    currentBalance: 'У вас очков: {pips}',
    notEnoughPips: 'Недостаточно очков для этой ставки',
    ...
    help:
      'Пригласите друзей, поделившись 8-значным кодом лобби, или используйте «Быструю игру» для поиска случайных соперников.',
    iAmReady: 'Я готов',
    waitingForOthers: 'Ждём других…',
    decline: 'Отказаться',
    keepPlaying: 'Продолжить игру',
    pot: 'Банк',
    open: 'Открыть',
    matchFoundConfirm: 'Игра найдена — подтвердите готовность',
    youAreReady: 'Вы готовы',
    minimizeHint: 'Можете закрыть окно и бросать кубики — позовём, когда найдём соперника.',
    unstableSearching: 'Нестабильно — продолжаем поиск…',
    reconnecting: 'Подключение…',
    matchCancelledDisconnect: 'Игрок потерял связь. Матч отменён, ставка возвращена.',
    matchCancelledNotReady: 'Кто-то не подтвердил готовность. Матч отменён, ставка возвращена.',
    matchCancelledDeclined: 'Игрок отказался. Матч отменён, ставка возвращена.',
    matchCancelled: 'Матч отменён. Ставка возвращена.',
    connectionLost: 'Соединение потеряно. Перезагрузите страницу.',
    matchmakingUnavailable: 'Матчмейкинг недоступен в этой сборке.',
    readyCounter: 'Готовы',
    close: 'Закрыть',
    rulesTitle: 'Правила',
  },
