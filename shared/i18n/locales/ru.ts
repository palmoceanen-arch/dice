...
export const ru: TranslationKeys = {
  ...
  // Лобби мультиплеера (Yandex Games)
  multiplayer: {
    title: 'Мультиплеер',
    createLobby: 'Создать лобби',
    joinByCode: 'Войти по коду',
    help: 'Пригласите друзей: поделитесь 8-значным кодом лобби. Победитель получает очки — без денежных ставок.',
    join: 'Войти',
    connecting: 'Подключение…',
    host: 'хост',
    you: 'вы',
    start: 'Начать матч',
    waitingHost: 'Ждём хоста, чтобы начать…',
    copy: 'Копировать код',
    leave: 'Выйти',
  },
