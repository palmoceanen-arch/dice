...
export const StreetCrapsMode = {
    ...
    processRoll(state, _playerId, dice1, dice2) {
        const total = dice1 + dice2;
        const crapsState = state.modeState;
        if (crapsState.phase === 'come_out') {
            ...
            if (total === 7 || total === 11) {
                ...
                const names = { 2: 'Snake Eyes', 3: 'Ace Deuce', 12: 'Boxcars' };
...
//# sourceMappingURL=streetCraps.js.map